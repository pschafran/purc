...
Usage: ./purc_recluster_new.py annoated_file output_folder clustID1 clustID2 clustID3 sizeThreshold1 sizeThreshold2
...
def ClusterDechimera(annotd_seqs_file, clustID, clustID2, clustID3, sizeThreshold, sizeThreshold2, verbose_level = 1): # M_p_barcode was set to FALSE, whcih led to splitting by taxon instead of barcode
	...
	outputfile_name_reconsensus = 'KNOX_clustered_reconsensus.fa' 
	...
	for bcode_folder in all_folders_bcodes: # have to go into each barcode folder in each locus folder
