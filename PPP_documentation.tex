...
%These renewcommands worked, but then those renewed entities didn't appear in the TOC.
% Trying another approach using \titleformat
...
%\addcontentsline{toc}{subsection}{subsection}  % This doesn't work. Shot in the dark
